...
{
    public void CreateCanvasForTarget(GameObject gameObject, EntityHealth entityHealth, UIElementsListData uIElementsListData, EnemyCanvasAnimation enemyCanvasAnimation)
    {
        Canvas canvas;
    ...
    private void CreateHealthBar(GameObject canvasGameObject, EntityHealth entityHealth, UIElementsListData uIElementsListData)
    {
