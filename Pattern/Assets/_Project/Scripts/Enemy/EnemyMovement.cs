...
public class EnemyMovement : MonoBehaviour
{
    ...
    public void Init(EnemyAttackArea enemyAttackArea, LookedOnTarget lookedOnTarget, Rigidbody rigidbody, EnemyEvasion enemyEvasion, IEntityHealthValue targetHealth, IMovable enemyData)
    {
